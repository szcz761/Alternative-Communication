...
namespace AC.Views
{
    ...
    public partial class MainPage : ContentPage
    {
        ...
        {
            InitializeComponent();
            // var monkeyList = new List<Image>();
            Images.Add(new Image { Source = "spanie", HeightRequest = 50, WidthRequest = 50 });
            Images.Add(new Image { Source = "spanie", HeightRequest = 50, WidthRequest = 50 });
            //Images.Add(new Image { Source = "spanie", HeightRequest = 50, WidthRequest = 50 });
            Images.Add(new Image { Source = "spanie", HeightRequest = 50, WidthRequest = 50 });
            //Images.Add(new Image { Source = "spanie", HeightRequest = 50, WidthRequest = 50 });
            Images.Add(new Image { Source = "spanie", HeightRequest = 50, WidthRequest = 50 });
            //Images.Add(new Image { Source = "spanie", HeightRequest = 50, WidthRequest = 50 });
            // monkeyList.Add(new Image { Source = "jedzenie", HeightRequest = 10, WidthRequest = 10 });

            VerticalPictures.ItemsSource = Images;
